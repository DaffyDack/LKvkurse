...
import NoPay from './pages/settings/NoPay';
import YesPay from './pages/settings/YesPay';
import PayTariffs from './pages/settings/PayTariffs';
import MyTariffs from './pages/settings/MyTariffs';
import YesEmail from './pages/settings/YesEmail';
...
function App() {
  ...
  return (
    <>
      {signin ? <Routes>
        <Route exact path="/" element={<Signin signin={signin} onChangeSignin={setSignin} />} />
        <Route exact path="/signin" element={<Signin signin={signin} onChangeSignin={setSignin} />} />
        <Route path="/signup" element={<Signup />} />
        <Route path="/settings/paytariffs" element={<Signin signin={signin} onChangeSignin={setSignin} />} />
      </Routes> :
        <Routes>
          <Route exact path="/signin" element={<Account />} />
          <Route exact path="/signup" element={<Account />} />
          <Route path="/settings/nopay" element={<NoPay />} />
          <Route path="/settings/yespay" element={<YesPay />} />
          <Route path="/settings/yesemail" element={<YesEmail />} />
          <Route path="/settings/paytariffs" element={<PayTariffs />} />
          <Route path="/settings/mytariffs" element={<MyTariffs />} />
