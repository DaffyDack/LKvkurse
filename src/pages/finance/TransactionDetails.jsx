            ...
            <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
              ...
              <div className="sm:flex sm:justify-between sm:items-center mb-4 md:mb-2">
                ...
                <div className="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2">
                  ...
                  {/* Export button */}
                  <button className="btn bg-green-500 hover:bg-green-600 text-white">Export Transactions</button>
                </div>
              </div>
              ...
              <div className="mb-5">
                <ul className="flex flex-wrap -m-1">
                  <li className="m-1">
                    <button className="inline-flex items-center justify-center text-sm font-medium leading-5 rounded-full px-3 py-1 border border-transparent shadow-sm bg-green-500 text-white duration-150 ease-in-out">
                      View All
                    </button>
                  </li>
                  <li className="m-1">
