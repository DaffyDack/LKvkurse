              ...
              <div className="max-w-md mx-auto">
                ...
                <form>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Link className="btn bg-green-500 hover:bg-green-600 text-white ml-auto" to="/onboarding-03">Next Step -&gt;</Link>
                  </div>
                </form>
