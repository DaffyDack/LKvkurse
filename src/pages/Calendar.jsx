          ...
          <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
            ...
            <div className="sm:flex sm:justify-between sm:items-center mb-4">
                ...
                <ul className="flex flex-wrap items-center -m-1">
                  <li className="m-1">
                    <button className="btn-sm bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700 hover:border-slate-300 dark:hover:border-slate-600 text-slate-500 dark:text-slate-400">
                      ...
                      <span className="ml-1.5">vkurse</span>
                    </button>
                  </li>
                  <li className="m-1">
                    <button className="btn-sm bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700 hover:border-slate-300 dark:hover:border-slate-600 text-slate-500 dark:text-slate-400">
                  ...
                  <li className="m-1">
                    <button className="btn-sm bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700 hover:border-slate-300 dark:hover:border-slate-600 text-green-500">+Add New</button>
                  </li>
                </ul>
              </div>
              ...
              <div className="flex flex-nowrap -space-x-px">
                <button className="btn bg-slate-50 dark:bg-slate-900 border-slate-200 dark:border-slate-700 hover:bg-slate-50 text-green-500 rounded-none first:rounded-l last:rounded-r">Month</button>
                      ...
                      <div className="relative bg-white dark:bg-slate-800 h-20 sm:h-28 lg:h-36 overflow-hidden" key={day}>
                        <div className="h-full flex flex-col justify-between">
                          ...
                          <div className="flex justify-between items-center p-0.5 sm:p-1.5">
                            ...
                            {/* Day number */}
                            <button className={`inline-flex ml-auto w-6 h-6 items-center justify-center text-xs sm:text-sm dark:text-slate-300 font-medium text-center rounded-full hover:bg-indigo-100 dark:hover:bg-slate-600 ${isToday(day) && 'text-green-500'}`}>{day}</button>
                          </div>
                        </div>
                      </div>                      
                    )
