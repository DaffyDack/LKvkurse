    ...
    return (
        <>
            <Form
                ...
                layout="vertical"
            >
                <div className='wrapReg Personale'>
                    <Form.Item
                        name="username"
                        label="Email"
                        rules={[
            ...
            <div className="pt-5 mt-6 border-t border-slate-200 dark:border-slate-700">
                <div className="text-sm">
                    У вас есть аккаунт? <Link className="font-medium text-green-500 hover:text-green-600 dark:hover:text-indigo-400 text-white" to="/signin">Войти</Link>
                </div>
            </div>
        </>
    );
