              ...
              <div>
                ...
                <div className="bg-white dark:bg-slate-800 p-5 shadow-lg rounded-sm border border-slate-200 mb-6 lg:hidden">
                  ...
                  <div className="space-y-2 sm:flex sm:space-y-0 sm:space-x-2">
                    <button className="btn w-full bg-green-500 hover:bg-green-600 text-white">Apply Today -&gt;</button>
                ...
                <div className="mb-6">
                  <div className="flex flex-wrap items-center -m-1">
                    <div className="m-1">
                      <a className="text-xs inline-flex font-medium bg-indigo-100 dark:bg-green-500/30 text-indigo-600 dark:text-indigo-400 rounded-full text-center px-2.5 py-1" href="#0">
                        Full-time
                      </a>
                    </div>
                    <div className="m-1">
                ...
                <div className="mt-6">
                  ...
                  <div className="flex justify-between items-center">
                    {/* Apply button */}
                    <button className="btn bg-green-500 hover:bg-green-600 text-white whitespace-nowrap">Apply Today -&gt;</button>
                    {/* Share */}
                    <div className="flex items-center">
                      <div className="text-sm text-slate-500 dark:text-slate-400 italic mr-4">Share:</div>
                      <div className="flex items-center space-x-3">
                        <button className="text-slate-400 dark:text-slate-500 hover:text-green-500 dark:hover:text-green-500">
