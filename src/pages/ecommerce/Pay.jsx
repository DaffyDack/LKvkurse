          ...
          <div className="bg-white dark:bg-slate-800 px-8 pb-6 rounded-b shadow-lg">
            ...
            {card && (
              <div>
                ...
                <div className="mt-6">
                  <div className="mb-4">
                    <button className="btn w-full bg-green-500 hover:bg-green-600 text-white">Pay $253.00</button>
                  </div>
            ...
            {!card && (
              <div>
                <div>
                  <div className="mb-4">
                    <button className="btn w-full bg-green-500 hover:bg-green-600 text-white">Pay with PayPal - $253.00</button>
                  </div>
                  <div className="text-xs text-slate-500 italic text-center">You'll be charged $253, including $48 for VAT in Italy</div>
                </div>
              </div>
