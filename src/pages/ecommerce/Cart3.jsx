                    ...
                    <form>
                      <div className="space-y-4">
                        ...
                        <div className="text-right">
                          <button type="submit" className="btn bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700 hover:border-slate-300 dark:hover:border-slate-600 text-green-500">
                            Download Invoice
                          </button>
                        </div>
                      </div>
                ...
                <div className="py-8 px-4 lg:px-8 2xl:px-12">
                  <div className="max-w-sm mx-auto lg:max-w-none">
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="mt-6">
                        <div className="mb-4">
                          <Link to="/ecommerce/pay" className="btn w-full bg-green-500 hover:bg-green-600 text-white">
                            View Your Order
                          </Link>
                        </div>
