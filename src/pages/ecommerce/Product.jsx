        ...
        <main className="grow">
          <div className="px-4 sm:px-6 lg:px-8 py-8 w-full">
            ...
            <div className="max-w-5xl mx-auto flex flex-col lg:flex-row lg:space-x-8 xl:space-x-16">
              ...
              <div>
                <div className="mb-3">
                  <a className="text-sm font-medium text-green-500 hover:text-green-600 dark:hover:text-indigo-400" href="#0">&lt;- Back To Listing</a>
                </div>
                ...
                <div>
                  ...
                  <div className="text-center">
                    <button className="btn bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700 hover:border-slate-300 dark:hover:border-slate-600 text-green-500">Load More Reviews</button>
                  </div>
                </div>
                ...
                <div>
                  ...
                  {/* Load More */}
                  <div className="text-center">
                    <button className="btn bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700 hover:border-slate-300 dark:hover:border-slate-600 text-green-500">Load More Stuff</button>
                  </div>
                </div>
              ...
              <div>
                <div className="bg-white dark:bg-slate-800 p-5 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700 lg:w-72 xl:w-80">
                  ...
                  <ul className="space-y-2 sm:flex sm:space-y-0 sm:space-x-2 lg:space-y-2 lg:space-x-0 lg:flex-col mb-4">
                    ...
                    <li>
                      <button className="w-full h-full text-left py-3 px-4 rounded bg-white dark:bg-slate-800 border-2 border-indigo-400 dark:border-indigo-500 shadow-sm duration-150 ease-in-out">
                        <div className="flex flex-wrap items-center justify-between mb-0.5">
                          <span className="font-semibold text-slate-800 dark:text-slate-100">Premium <span className="text-xs italic text-green-500 align-top">Best Value ✨</span></span>
                  ...
                  <div className="mb-4">
                    <a className="btn w-full bg-green-500 hover:bg-green-600 text-white" href="#0">Buy Now - $69.00</a>
                  </div>
