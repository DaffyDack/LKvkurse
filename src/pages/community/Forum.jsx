                  ...
                  <div className="md:py-8">
                    ...
                    <div className="mb-4">
                      <div className="w-full flex flex-wrap -space-x-px">
                        <button className="btn grow bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700 text-green-500 rounded-none first:rounded-l last:rounded-r">Popular</button>
                    ...
                    <div className="mt-6 text-right">
                      <nav className="inline-flex" role="navigation" aria-label="Navigation">
                        <ul className="flex justify-center">
                          ...
                          <li className="ml-3 first:ml-0">
                            <a className="btn bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700 hover:border-slate-300 dark:hover:border-slate-600 text-green-500" href="#0">Next -&gt;</a>
                          </li>
                        </ul>
                      </nav>
                    </div>
