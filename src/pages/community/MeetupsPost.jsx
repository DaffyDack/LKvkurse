          ...
          <div className="px-4 sm:px-6 lg:px-8 py-8 w-full">
            ...
            <div className="max-w-5xl mx-auto flex flex-col lg:flex-row lg:space-x-8 xl:space-x-16">
              ...
              <div>
                ...
                <div className="text-sm font-semibold text-green-500 uppercase mb-2">Mon 27 Dec, 2021 - 9:00 PM -&gt; 10:00 PM</div>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-white dark:bg-slate-800 p-5 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700 lg:w-72 xl:w-80">
                  <div className="space-y-2">
                    <button className="btn w-full bg-green-500 hover:bg-green-600 text-white">
                ...
                <div className="bg-white dark:bg-slate-800 p-5 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700 lg:w-72 xl:w-80">
                  <div className="flex justify-between space-x-1 mb-5">
                    ...
                    <a className="text-sm font-medium text-green-500 hover:text-green-600 dark:hover:text-indigo-400" href="#0">
                      View All
                    </a>
                  </div>
                  ...
                  <ul className="space-y-3">
                    <li>
                      <div className="flex items-center justify-between">
                        ...
                        <button className="text-xs inline-flex font-medium bg-indigo-100 dark:bg-green-500/30 text-indigo-600 dark:text-indigo-400 rounded-full text-center px-2.5 py-1">
                          Invite
                        </button>
                      </div>
                    </li>
