              ...
              <div className="space-y-8 mt-8">
                ...
                <div>
                  <div className="flex items-start space-x-3 mb-6">
                    ...
                    <div className="text-xs inline-flex font-medium bg-indigo-100 dark:bg-green-500/30 text-indigo-600 dark:text-indigo-400 rounded-full text-center px-2.5 py-1">Recommended</div>
                  </div>
                  <div className="px-6 py-8 bg-slate-800 rounded-sm text-center xl:text-left xl:flex xl:flex-wrap xl:justify-between xl:items-center">
                    ...
                    <div className="inline-flex space-x-3">
                      <a className="btn bg-green-500 hover:bg-green-600 text-white" href="https://nucleoapp.com/pricing" target="_blank" rel="noreferrer">Buy Nucleo</a>
                ...
                <div>
                  ...
                  <div className="px-6 py-8 bg-slate-800 rounded-sm text-center xl:text-left xl:flex xl:flex-wrap xl:justify-between xl:items-center">
                    ...
                    <div className="inline-flex space-x-3">
                      <a className="btn bg-green-500 hover:bg-green-600 text-white" href="https://tablericons.com/" target="_blank" rel="noreferrer">Download Tabler Icons</a>
                    </div>
                  </div>
                </div>
