              ...
              <div className="space-y-8 mt-8">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap items-center -m-1.5">
                    <div className="m-1.5">
                      {/* Start */}
                      <button className="btn bg-green-500 hover:bg-green-600 text-white">Primary</button>
                      {/* End */}
                    </div>
                    <div className="m-1.5">
                      {/* Start */}
                      <button className="btn dark:bg-slate-800 border-slate-200 dark:border-slate-700 hover:border-slate-300 dark:hover:border-slate-600 text-green-500">Secondary</button>
                      {/* End */}
                    </div>
                    <div className="m-1.5">
                      {/* Start */}
                ...
                <div>
                  ...
                  <div className="flex flex-wrap items-center -m-1.5">
                    <div className="m-1.5">
                      {/* Start */}
                      <button className="btn w-full bg-green-500 hover:bg-green-600 text-white disabled:border-slate-200 dark:disabled:border-slate-700 disabled:bg-slate-100 dark:disabled:bg-slate-800 disabled:text-slate-400 dark:disabled:text-slate-600 disabled:cursor-not-allowed shadow-none" disabled>Disabled</button>
                      {/* End */}
                    </div>
                    <div className="m-1.5">
                      {/* Start */}
                      <button className="btn w-full bg-green-500 hover:bg-green-600 text-white disabled:border-slate-200 dark:disabled:border-slate-700 disabled:bg-slate-100 dark:disabled:bg-slate-800 disabled:text-slate-400 dark:disabled:text-slate-600 disabled:cursor-not-allowed shadow-none" disabled>
                ...
                <div>
                  ...
                  <div className="flex flex-wrap items-center -m-1.5">
                    <div className="m-1.5">
                      {/* Start */}
                      <button className="btn-xs bg-green-500 hover:bg-green-600 text-white">Button</button>
                      {/* End */}
                    </div>
                    <div className="m-1.5">
                      {/* Start */}
                      <button className="btn-sm bg-green-500 hover:bg-green-600 text-white">Button</button>
                      {/* End */}
                    </div>
                    <div className="m-1.5">
                      {/* Start */}
                      <button className="btn bg-green-500 hover:bg-green-600 text-white">Button</button>
                      {/* End */}
                    </div>
                    <div className="m-1.5">
                      {/* Start */}
                      <button className="btn-lg bg-green-500 hover:bg-green-600 text-white">Button</button>
                      {/* End */}
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="flex flex-wrap items-center -m-1.5">
                    ...
                    <div className="m-1.5">
                      {/* Start */}
                      <button className="btn dark:bg-slate-800 border-slate-200 dark:border-slate-700 hover:border-slate-300 dark:hover:border-slate-600">
                        <svg className="w-4 h-4 fill-current text-green-500 shrink-0" viewBox="0 0 16 16">
                  ...
                  <div className="flex flex-wrap items-center -m-1.5">
                    <div className="m-1.5">
                      ...
                      <div className="flex flex-wrap -space-x-px">
                        <button className="btn bg-green-600 text-white rounded-none border-l-indigo-400 first:rounded-l last:rounded-r first:border-l-transparent">Weekly</button>
                        <button className="btn bg-green-500 hover:bg-green-600 text-indigo-100 rounded-none border-l-indigo-400 first:rounded-l last:rounded-r first:border-r-transparent">Monthly</button>
                        <button className="btn bg-green-500 hover:bg-green-600 text-indigo-100 rounded-none border-l-indigo-400 first:rounded-l last:rounded-r first:border-r-transparent">Yearly</button>
                      </div>
                      {/* End */}
                    </div>
                    <div className="m-1.5">
                      {/* Start */}
                      <div className="flex flex-wrap -space-x-px">
                        <button className="btn bg-slate-50 dark:bg-slate-900 border-slate-200 dark:border-slate-700 hover:bg-slate-50 text-green-500 rounded-none first:rounded-l last:rounded-r">Weekly</button>
