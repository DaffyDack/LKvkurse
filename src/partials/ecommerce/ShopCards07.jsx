      ...
      <div className="col-span-full md:order-1 xl:order-none">
        <div className="h-full p-6 bg-slate-800 rounded-sm text-center xl:text-left xl:flex xl:justify-between xl:items-center">
          <div className="mb-4 xl:mb-0 xl:mr-4">
            <div className="text-xl text-slate-50 font-semibold mb-1">Excepteur sint occaecat <span className="text-green-500">cupidatat</span> 🎁</div>
          ...
          <button className="btn bg-green-500 hover:bg-green-600 text-white shrink-0">Reedem Now!</button>
        </div>
      </div>
