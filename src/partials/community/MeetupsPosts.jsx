    ...
    <div className="grid xl:grid-cols-2 gap-6">
      ...
      <article className="flex bg-white dark:bg-slate-800 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700 overflow-hidden">
        ...
        <div className="grow p-5 flex flex-col">
          <div className="grow">
            <div className="text-sm font-semibold text-green-500 uppercase mb-2">Mon 27 Dec, 2021</div>
      ...
      <article className="flex bg-white dark:bg-slate-800 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700 overflow-hidden">
        ...
        <div className="grow p-5 flex flex-col">
          <div className="grow">
            <div className="text-sm font-semibold text-green-500 uppercase mb-2">Wed 29 Dec, 2021</div>
            <Link className="inline-flex mb-2" to="/community/meetups-post">
      ...
      <article className="flex bg-white dark:bg-slate-800 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700 overflow-hidden">
        ...
        <div className="grow p-5 flex flex-col">
          <div className="grow">
            <div className="text-sm font-semibold text-green-500 uppercase mb-2">Mon 3 Jan, 2022</div>
            <Link className="inline-flex mb-2" to="/community/meetups-post">
              <h3 className="text-lg font-bold text-slate-800 dark:text-slate-100">vkurse London Meetup: Women in Tech Night</h3>
            </Link>
            <div className="text-sm">
              Lorem ipsum is placeholder text commonly used in the graphic, print, and publishing industries for previewing layouts.
            </div>
      ...
      <article className="flex bg-white dark:bg-slate-800 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700 overflow-hidden">
        ...
        <div className="grow p-5 flex flex-col">
          <div className="grow">
            <div className="text-sm font-semibold text-green-500 uppercase mb-2">Thu 6 Jan, 2022</div>
            <Link className="inline-flex mb-2" to="/community/meetups-post">
      ...
      <article className="flex bg-white dark:bg-slate-800 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700 overflow-hidden">
        ...
        <div className="grow p-5 flex flex-col">
          <div className="grow">
            <div className="text-sm font-semibold text-green-500 uppercase mb-2">Fri 7 Jan, 2022</div>
            <Link className="inline-flex mb-2" to="/community/meetups-post">
