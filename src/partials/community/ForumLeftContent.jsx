        ...
        <div className="md:py-8">
          <div className="flex justify-between items-center md:block">
            ...
            <div className="xl:hidden mb-6">
              <button className="btn md:w-full bg-green-500 hover:bg-green-600 text-white">Create Post</button>
            </div>
          </div>
              ...
              <ul className="flex flex-nowrap md:block mr-3 md:mr-0">
                <li className="mr-0.5 md:mr-0 md:mb-0.5">
                  <a className="flex items-center px-2.5 py-2 rounded whitespace-nowrap bg-white dark:bg-slate-800" href="#0">
                    <svg className="w-4 h-4 shrink-0 fill-current text-green-500 mr-2" viewBox="0 0 16 16">
                    ...
                    <span className="text-sm font-medium text-green-500">Home</span>
                  </a>
                </li>
                <li className="mr-0.5 md:mr-0 md:mb-0.5">
