        ...
        <div>
                ...
                <div className="relative">
                  <div className="grow flex items-center truncate">
                    ...
                    <div className="truncate">
                      <span className="font-semibold text-slate-800 dark:text-slate-100">vkurse</span>
                    </div>
                  </div>
                </div>
                {/* Add button */}
          ...
          <div className="px-5 py-4">
            ...
            <div className="mt-4">
              ...
              <ul className="mb-6">
                <li className="-mx-2">
                  <button className="w-full p-2 rounded bg-green-500/30" onClick={() => setProfileSidebarOpen(false)}>
