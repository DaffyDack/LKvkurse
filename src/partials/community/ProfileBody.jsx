        ...
        <header className="text-center sm:text-left mb-6">
          ...
          <div className="flex flex-wrap justify-center sm:justify-start space-x-4">
            ...
            <div className="flex items-center">
              ...
              <a className="text-sm font-medium whitespace-nowrap text-green-500 hover:text-green-600 dark:hover:text-indigo-400 ml-2" href="#0">
                carolinmcneail.com
              </a>
            </div>
          </div>
        ...
        <div className="relative mb-6">
          ...
          <ul className="relative text-sm font-medium flex flex-nowrap -mx-4 sm:-mx-6 lg:-mx-8 overflow-x-scroll no-scrollbar">
            <li className="mr-6 last:mr-0 first:pl-4 sm:first:pl-6 lg:first:pl-8 last:pr-4 sm:last:pr-6 lg:last:pr-8">
              <a className="block pb-3 text-green-500 whitespace-nowrap border-b-2 border-indigo-500" href="#0">
                General
              </a>
            </li>
            <li className="mr-6 last:mr-0 first:pl-4 sm:first:pl-6 lg:first:pl-8 last:pr-4 sm:last:pr-6 lg:last:pr-8">
              ...
              <div className="bg-white dark:bg-slate-800 p-4 border border-slate-200 dark:border-slate-700 rounded-sm shadow-sm">
                <ul className="space-y-3">
                  ...
                  <li className="sm:flex sm:items-center sm:justify-between">
                    <div className="sm:grow flex items-center text-sm">
                      {/* Icon */}
                      <div className="w-8 h-8 rounded-full shrink-0 bg-green-500 my-2 mr-3">
