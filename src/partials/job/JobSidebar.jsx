...
function JobSidebar() {
  ...
  return (
    <div className="space-y-8">
      {/* Alert */}
      <div className="relative bg-indigo-200 dark:bg-green-500 rounded-sm p-5 min-w-60">
        ...
        <div className="relative">
          ...
          <div className="text-right">
            <a className="text-sm font-medium text-green-500 dark:text-indigo-50 hover:text-green-600 dark:hover:text-white" href="#0">
              Create Alert -&gt;
            </a>
          </div>
        </div>
