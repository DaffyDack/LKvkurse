      ...
      <div className="px-5 py-6">
        <div className="md:flex md:justify-between md:items-center">
          ...
          <ul className="shrink-0 flex flex-wrap justify-end md:justify-start -space-x-3 -ml-px">
            ...
            <li>
              <button className="flex justify-center items-center w-9 h-9 rounded-full bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 hover:border-slate-300 dark:hover:border-slate-600 text-green-500 shadow-sm transition duration-150">
