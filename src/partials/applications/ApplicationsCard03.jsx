      ...
      case 0:
        return (
          <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24">
            ...
            <path className="text-green-500" d="M13 15.047V24l10.573-7.181A.999.999 0 0024 16V8l-11 7.047z" />
          </svg>
        );
      case 1:
        return (
  ...
  return (
    <div className="col-span-full sm:col-span-6 xl:col-span-3 bg-white dark:bg-slate-800 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700">
      <div className="flex flex-col h-full text-center p-5">
        ...
        <div>
          <Link className="text-sm font-medium text-green-500 hover:text-green-600 dark:hover:text-indigo-400" to={props.link}>Explore -&gt;</Link>
        </div>
      </div>
    </div>
  );
