          ...
          <ul>
            <li className="md:flex md:justify-between md:items-center py-3 border-b border-slate-200 dark:border-slate-700">
              ...
              <div className="text-sm text-slate-600 dark:text-slate-400 ml-4">
                ...
                <a className="font-medium text-green-500 hover:text-green-600 dark:hover:text-indigo-400" href="#0">Edit</a>
              </div>
            </li>
            <li className="md:flex md:justify-between md:items-center py-3 border-b border-slate-200 dark:border-slate-700">
              {/* Left */}
              ...
              <tr className="flex flex-wrap md:table-row md:flex-no-wrap border-b border-slate-200 dark:border-b border-slate-700 py-2 md:py-0">
                ...
                <td className="w-full block md:w-auto md:table-cell py-0.5 md:py-2">
                  <div className="text-right flex items-center md:justify-end">
                    <a className="font-medium text-green-500 hover:text-green-600 dark:hover:text-indigo-400" href="#0">HTML</a>
                    <span className="block w-px h-4 bg-slate-200 dark:bg-slate-700 mx-2" aria-hidden="true"></span>
                    <a className="font-medium text-green-500 hover:text-green-600 dark:hover:text-indigo-400" href="#0">PDF</a>
                  </div>
                </td>
              </tr>
              {/* Row */}
      ...
      <footer>
        <div className="flex flex-col px-6 py-5 border-t border-slate-200 dark:border-slate-700">
          <div className="flex self-end">
            ...
            <button className="btn bg-green-500 hover:bg-green-600 text-white ml-3">Save Changes</button>
          </div>
        </div>
      </footer>
