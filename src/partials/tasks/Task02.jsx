  ...
  return (
    <div className="bg-white dark:bg-slate-800 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700 p-4">
      ...
      <div className="flex items-center justify-between">
        {/* Left side */}
        <button className="p-2 shrink-0 rounded-full bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 hover:border-slate-300 dark:hover:border-slate-600 text-green-500 transition duration-150">
        ...
        <div className="flex items-center">
          ...
          {/* Replies button */}
          <button className="flex items-center text-slate-400 dark:text-slate-500 hover:text-green-500  dark:hover:text-green-500 ml-3">
            <svg className="w-4 h-4 shrink-0 fill-current mr-1.5" viewBox="0 0 16 16">
          ...
          {/* Attach button */}
          <button className="text-slate-400 dark:text-slate-500 hover:text-green-500  dark:hover:text-green-500 ml-3">
            <svg className="w-4 h-4 shrink-0 fill-current mr-1.5" viewBox="0 0 16 16">
