      ...
      >
        ...
        >
          ...
          <ul>
            <li>
              <Link
                className="font-medium text-sm text-green-500 hover:text-green-600 dark:hover:text-indigo-400 flex items-center py-1 px-3"
                to="#0"
                onClick={() => setDropdownOpen(!dropdownOpen)}
              >
                <svg className="w-3 h-3 fill-current text-indigo-300 dark:text-green-500 shrink-0 mr-2" viewBox="0 0 12 12">
