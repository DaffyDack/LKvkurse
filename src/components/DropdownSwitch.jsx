    ...
    <div className="relative">
      ...
      >
        ...
        <div className="truncate">
          <span className="text-sm font-medium dark:text-slate-300 group-hover:text-slate-800 dark:group-hover:text-slate-200">vkurse</span>
        </div>
            ...
            <a className="font-medium text-sm text-slate-600 dark:text-slate-300 hover:text-slate-800 dark:hover:text-slate-200 block py-1.5 px-3" href="#0" onClick={() => setDropdownOpen(false)}>
              <div className="flex items-center justify-between">
                <div className="grow flex items-center truncate">
                  ...
                  <div className="truncate">vkurse</div>
                </div>
                <svg className="w-3 h-3 shrink-0 fill-current text-green-500 ml-1" viewBox="0 0 12 12">
